...
const demoScripts: ScriptRecord[] = [
  {
    ...
    publishedAt: new Date("2026-04-18T12:00:00.000Z"), demo: true,
  },
  {
    ...
    publishedAt: new Date("2026-05-01T12:00:00.000Z"), demo: true,
  },
]

const scriptSelection = {
  id: scripts.id, slug: scripts.slug, title: scripts.title,
  description: scripts.description, code: scripts.code, status: scripts.status,
  published: scripts.published, authorId: scripts.authorId, authorName: user.name,
