...
#### `CreatureRemoveProxy:OnReceive(callback, creatureId)`
...
#### `PacketEventProxy:OnPacket(callback)`
...
#### `PacketEventProxy:OnReceive(callback)`
...
#### `PacketEventProxy:OnSend(callback)`
