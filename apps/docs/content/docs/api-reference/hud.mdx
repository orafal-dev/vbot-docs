...
#### `ScreenImage:New(id, renderLayer)`

**Parameters**

| Name | Type | Optional | Description |
| :-- | :-- | :--: | :-- |
| `renderLayer` | `string` | Yes | Optional HUDRenderLayer value |
...
#### `ScreenImage:SetOnDragEnd(callback, y)`
...
#### `ScreenImage:SetOnMouseDown(callback)`
...
#### `ScreenImage:SetOnMouseLeave(callback)`
...
#### `ScreenImage:SetOnMouseUp(callback)`
...
#### `ScreenImage:SetPointerCallbacks(onMouseDown, onMouseUp, onMouseLeave)`

**Parameters**

| Name | Type | Optional | Description |
| :-- | :-- | :--: | :-- |
| `onMouseDown` | `function()\|false` | Yes |  |
| `onMouseUp` | `function()\|false` | Yes |  |
| `onMouseLeave` | `function()\|false` | Yes |  |
...
#### `ScreenImage:SetRenderLayer(renderLayer)`
...
| Name | Type | Optional | Description |
| :-- | :-- | :--: | :-- |
| `renderLayer` | `string` |  | HUDRenderLayer.MAP or HUDRenderLayer.OVERLAY |
...
#### `ScreenImage:SetSourceBase64(base64Image)`
...
#### `ScreenImage:SetSourceBytes(imageBytes)`
...
#### `ScreenText:SetFont(family, pixelSize)`
...
| Name | Type | Optional | Description |
| :-- | :-- | :--: | :-- |
| `family` | `string\|nil` |  | Installed system-font family name |
| `pixelSize` | `integer\|nil` |  | Font size in pixels (1-256) |
...
#### `ScreenText:SetFontFamily(family)`
...
#### `ScreenText:SetFontSize(pixelSize)`
...
#### `ScreenText:SetOnDragEnd(callback, y)`
...
#### `ScreenText:SetOnMouseDown(callback)`
...
#### `ScreenText:SetOnMouseLeave(callback)`
...
#### `ScreenText:SetOnMouseUp(callback)`
...
#### `ScreenText:SetPointerCallbacks(onMouseDown, onMouseUp, onMouseLeave)`
...
#### `ScreenText:SetRenderLayer(renderLayer)`
...
#### `WorldBox:New(id, x, y, z, renderLayer)`
...
#### `WorldBox:SetRenderLayer(renderLayer)`
...
#### `WorldImage:New(id, x, y, z, renderLayer)`
...
#### `WorldImage:SetLabel(text, color, offsetX, offsetY)`
...
| Name | Type | Optional | Description |
| :-- | :-- | :--: | :-- |
| `text` | `string\|nil` |  | Label text; nil clears it |
| `color` | `table` | Yes | Optional \{r, g, b, a\} label color |
| `offsetX` | `number` | Yes | Optional horizontal pixel offset |
| `offsetY` | `number` | Yes | Optional vertical pixel offset |
...
#### `WorldImage:SetRenderLayer(renderLayer)`
...
#### `WorldImage:SetSourceBase64(base64Image)`
...
#### `WorldImage:SetSourceBytes(imageBytes)`
...
#### `WorldText:New(id, x, y, z, renderLayer)`
...
#### `WorldText:SetFont(family, pixelSize)`
...
#### `WorldText:SetFontFamily(family)`
...
#### `WorldText:SetFontSize(pixelSize)`
...
#### `WorldText:SetRenderLayer(renderLayer)`
