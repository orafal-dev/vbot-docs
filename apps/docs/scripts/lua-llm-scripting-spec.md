...
"Generate a production-safe ValidusBot Lua script using only APIs from the attached spec. Script goal:. Include robust nil checks, validation, and non-blocking scheduling. Do not use unsupported modifiers/features. Return one complete .lua file." 
